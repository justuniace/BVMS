...
<head>
    ...
    <link rel="stylesheet" href="../../../css/admin/status/first-dose-record.css">
        ...
        <div class="lower">
            <div class="subheader">
                <ul>
                    ...
                    <li>
                        <a class="first-dose-h" href="first-dose.php">First Dose</a>
                    </li>
                    <li>
                        <a href="unvaccinated.php">Unvaccinated</a>
                    </li>
                </ul>
            </div>
            <table class="records">
